...
JAZZMIN_SETTINGS = {
    ...
    "hide_apps": [],
    "hide_models": [],
    "order_with_respect_to": [ "users","users.CustomUser","users.UserOtp","shop","shop.Category", "shop.Products", "shop.Order", "shop.OrderItem","shop.CommentProducts","shop.Cart","shop.ImageProducts"],
